...
This document records the conditional status of the Poincaré-New-Derivation artifact as of 2026-05-01.
...
This is a documentation and tooling lock. It does not modify Lean source files, does not introduce new Lean axioms, does not introduce placeholder predicates, and does not rename existing Lean lemmas.
...
|---|---:|---:|---:|---:|
| `lean/Poincare/FinalConstructive.lean` | 16 | 0 | 0 | 16 |
