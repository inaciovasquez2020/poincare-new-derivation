...
/-- Once aligned legal Move23 output has been absorbed into the certified
nonself high-edge branch, perpetual witnessed source-face reentry requires
only exclusion of strict descent and nonself high-edge escape. -/
theorem ClosedTriangulationCore.exists_perpetual_witnessedReentry_of_noDescent_noHigh
    {K : Triangulation}
